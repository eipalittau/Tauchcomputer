...
Pressure::Pressure() : I2CBase(0x76) { //I2C-Adress
	...
	unsigned int lCalibrationData[7];
...
//Private
unsigned long Pressure::ReadData(unsigned char aRegister) {
...
unsigned char Pressure::CheckCrc(unsigned int n_prom[]) {
